    ...
    <div class="container">
        ...
        <article id="article">
            ...
            <div class="laws">
                ...
                <?php endforeach; ?>
                <a href="#" data-post-type="digest" data-type="<?= $consulting->slug;?>"data-category="<?= $ajaxCategory;?>" data-offset="3" id="consulting-more-posts" class="load-more">Загрузить больше</a>
            </div>
        </article>
    </div>
</main>