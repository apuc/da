            ...
            <?php if (!empty($news)): ?>
                <?php foreach ($news as $new): ?>
                    <div class="news-posts__item" style="height:270px">
                        <?php $dt = ($new->dt_public != $new->dt_add) ? $new->dt_public : $new->dt_add; ?>
                        ...
                        <a href="/news/<?= $new->slug ?>">
                            <h5 class="post-header"><?= $new->title ?></h5>
                            <div class="post-image">
                                <img src="<?= $new->photo ?>" alt="">
                            </div>
                            <p class="text-preview"><?= WordFunctions::crop_str_word(strip_tags($new->content), 15); ?></p>
                        </a>
                        <a href="/news/<?= $new->slug ?>" class="read-more more-news-link">Читать дальше <img
