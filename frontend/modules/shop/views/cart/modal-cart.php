...
<div class="shop__top-sales-elements ">
    ...
    foreach ($model as $item):?>
        ...
        <a href="<?= Url::to(['/shop/shop/show', 'slug' => $item['products']->slug])?>" class="shop__top-sales-elements--item">
            ...
            <div class="category-photo">
                ...
                if (!empty($item['products']->cover)): ?>
                    <img src="<?= \common\models\UploadPhoto::getImageOrNoImage( $item['products']->cover); ?>" alt="<?= $item['products']->title; ?>">
                <?php else: ?>
