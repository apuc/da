...
<?= $form->field($model, 'title')->textInput(['maxlength' => 70])
    ->hint('Наименование предлагаемого товара. В заголовке запрещено размещать контактную информацию, а также использовать заглавные буквы (кроме аббревиатур).'
    )
...
<?= $form->field($model, 'company_id')
    ...
    ->hint('Компания, которая занимается продажей товара.')
    ->label('Компания<span>*</span>')
?>

<?= $form->field($model, 'price')->textInput()
    ->hint('Цена товара в российских рублях. Запрещено указывать нереальную или условную стоимость.')
    ->label('Цена<span>*</span>')
?>

<?= $form->field($model, 'new_price')->textInput()
    ->hint('Обновленная цена товара, если он выставлен на продажу со скидкой. В противном случае поле необходимо оставить  пустым.')
    ->label('Новая цена')
?>
