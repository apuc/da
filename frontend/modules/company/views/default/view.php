...
?>
    ...
    <span
        ...
        <p><b>Адрес:</b> <span style="display: inline-block;"
                               class="map-company-location"><?= $company->address ?></span></p>
    ...
    <div id="map"
         style="width: 100%; height: 300px; padding: 0; padding-left: 80px; margin: 0; display: block; float: left;"></div>
    <div class="post-nav">
    ...
    <div class="another-news">
        <div class="rand-cat-news">
            ...
            <?php foreach ($related_company as $related_new): ?>
                <a href="<?= Url::to(['/company/default/view', 'slug' => $related_new->slug]) ?>"
        ...
        <div class="best-views-news">
            ...
            <?php foreach ($most_popular_company as $most_popular_new): ?>
                <a href="<?= Url::to(['/company/default/view', 'slug' => $most_popular_new->slug]) ?>"
                   class="news-like-item">
...
<?= \frontend\widgets\Comments::widget([
    'postId' => $company->id,
    'postType' => 'company',
    'pageTitle' => 'Комментарии к компании',
]); ?>