...
/**
 * This is the model class for table "pages_comments".
 *
 * @property int $id
 ...
 */
class PagesComments extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['pages_id', 'user_id', 'dt_add', 'parent_id', 'moder_checked', 'published', 'verified'], 'integer'],
            [['content'], 'string'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'pages_id' => Yii::t('comments', 'Pages ID'),
