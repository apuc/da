...
/**
 * CategoryNewsSearch represents the model behind the search form about `backend\modules\category\models\CategoryNews`.
 */
class CategoryNewsSearch extends CategoryNews
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'descr', 'icon', 'meta_title', 'meta_descr'], 'safe'],
        ];
    }
