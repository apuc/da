...
/**
 * CategoryPosterSearch represents the model behind the search form about `backend\modules\category_poster\models\CategoryPoster`.
 */
class CategoryPosterSearch extends CategoryPoster
{
    /**
     * @inheritdoc
     */
