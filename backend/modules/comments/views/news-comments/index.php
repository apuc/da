...
/* @var $searchModel backend\modules\comments\models\NewsCommentsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('comments', 'News Comments');
        ...
        'columns' => [
            ...
            [
                ...
                'checkboxOptions' => function ($model) {
                    return ['value' => $model->id, 'data-type' => 'news'];
                }
            ],
            //id
            'content:ntext',
            [
                'attribute' => 'news_id',
                'format' => 'raw',
                'label' => Yii::t('comments', 'News ID'),
                'value' => function ($model) {
                    if (empty($model->news_id)) {
                        $html = 'Нет';
                    } else {
                        $result = News::find()->where(['id' => $model->news_id])->one();
