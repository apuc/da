...
/* @var $searchModel backend\modules\comments\controllers\PagesCommentsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('comments', 'Pages Comments');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pages-comments-index">
        ...
        'columns' => [
            ...
            [
                ...
                'checkboxOptions' => function ($model) {
                    return ['value' => $model->id, 'data-type' => 'pages'];
                }
            ],
            //id
            'content:ntext',
            [
                'attribute' => 'pages_id',
                'format' => 'raw',
                'label' => Yii::t('comments', 'Pages ID'),
                'value' => function ($model) {
                    if (empty($model->pages_id)) {
                        $html = 'Нет';
                    } else {
                        $result = Pages::find()->where(['id' => $model->pages_id])->one();
