...
/* @var $searchModel backend\modules\comments\models\StockCommentsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('comments', 'Stock Comments');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="stock-comments-index">
        ...
        'columns' => [
            ...
            [
                ...
                'checkboxOptions' => function ($model) {
                    return ['value' => $model->id, 'data-type' => 'stock'];
                }
            ],
            //id
            'content:ntext',
            [
                'attribute' => 'stock_id',
                'format' => 'raw',
                'label' => Yii::t('comments', 'Stock ID'),
                'value' => function ($model) {
                    if (empty($model->stock_id)) {
                        $html = 'Нет';
                    } else {
                        $result = Stock::find()->where(['id' => $model->stock_id])->one();
