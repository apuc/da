...
/**
 * NewsCommentsSearch represents the model behind the search form of `common\models\db\NewsComments`.
 */
class NewsCommentsSearch extends NewsComments
{
    ...
    {
        return [
            [['id', 'news_id', 'user_id', 'dt_add', 'parent_id', 'moder_checked', 'published', 'verified'], 'integer'],
            [['content'], 'safe'],
        ];
    }
